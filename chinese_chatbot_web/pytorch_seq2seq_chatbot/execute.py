...
gConfig = get_config.get_config(config_file='seq2seq.ini')
...
def train():
    ...
    while True:
        ...
        for i in range(0, max_data - 1):
            ...
            batch_loss = seq2seqModel.train_step(inp, targ, encoder1, attn_decoder1,
...
if __name__ == '__main__':
    if len(sys.argv) - 1:
        gConfig = get_config.get_config(sys.argv[1])
    else:
